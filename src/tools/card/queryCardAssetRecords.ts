// queryCardAssetRecords.ts — hand-written tool for POST /v5/card/transaction/query-asset-records
// Source: https://bybit-exchange.github.io/docs/v5/bybit-card/asset-records
//
// The handler strips the internal `uid` and card BIN `pan6` from each record before returning
// (see the Privacy note in the tool description below).
import { z } from 'zod';
