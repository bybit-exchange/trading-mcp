...
export const executePurchase = {
  ...
  handler: async (input: Record<string, unknown>) => {
    return restClient.postAuth("/v5/alpha/trade/purchase", (({ confirm: _confirm, ...rest }) => rest)(input));
  },
};
