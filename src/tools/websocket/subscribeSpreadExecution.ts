// subscribeSpreadExecution.ts — auto-generated, do not edit
import { z } from 'zod';
import { wsClient } from '../../client/ws-client.js';
import type { WsCategory } from '../../client/ws-client.js';

export const subscribeSpreadExecution = {
  name: 'subscribeSpreadExecution',
  description: "订阅 Spread 成交推送（需要鉴权）",
