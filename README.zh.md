...
[![Tools](https://img.shields.io/badge/Tools-180-orange.svg)](#-工具分类)
[![Bybit V5 API](https://img.shields.io/badge/Bybit-V5%20API-green.svg)](https://bybit-exchange.github.io/docs/v5/intro)

**生产就绪的 Bybit MCP 服务器 — 180 个工具，覆盖行情数据、交易下单、仓位管理、账户管理、资产查询和 WebSocket 实时推送**
...
- **完整的 V5 覆盖** — 180 个工具，涵盖行情、交易、仓位、账户、资产、用户和 WebSocket 七大类
